var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"I611": {
		...
		"itemEffectTip": "，攻击+40000"
	},
	"I612": {
		"cls": "items",
		"name": "森林剑",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += 400000",
		"itemEffectTip": "，攻击+40万"
	},
	"I613": {
		"cls": "items",
		"name": "灰暗剑",
	...
	"I615": {
		...
		"itemEffect": "core.status.hero.atk += 60",
		"itemEffectTip": "，攻击+60"
	},
	"I616": {
		"cls": "items",
	...
	"I629": {
		...
		"name": "残墟剑",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += 1.2e8",
		"itemEffectTip": "，攻击+1.2亿"
	},
	"I630": {
		"cls": "items",
		"name": "极夜之剑",
	...
	"I654": {
		...
		"name": "力量结晶",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += 2000e4",
		"itemEffectTip": "，攻击+2000万"
	},
	"I655": {
		"cls": "items",
		"name": "炙热果实",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += 600e4",
		"itemEffectTip": "，攻击+600万"
	},
	"I656": {
		"cls": "items",
		"name": "新物品",
	...
	"I735": {
		...
		"canUseItemEffect": "true",
		"text": "天地间充沛的能量滋养诞生的晶体，\n接触后能够化作海量的经验为人所用。\n角色增加50亿经验。",
		"itemEffect": "core.status.hero.exp += 3000e4",
		"itemEffectTip": "，经验+3000万"
	},
	"I736": {
		"cls": "items",
		"name": "极品进化结晶",
		"canUseItemEffect": "true",
		"text": "天地间充沛的能量滋养诞生的晶体，\n接触后能够化作海量的经验为人所用。\n角色增加1000亿经验。",
		"itemEffect": "core.status.hero.exp += 4e8",
		"itemEffectTip": "，经验+4亿"
	},
	"I737": {
		"cls": "items",
		...
		"canUseItemEffect": "true",
		"text": "天地间充沛的能量滋养诞生的晶体，\n接触后能够化作海量的领悟为人所用。\n角色增加3兆经验。",
		"itemEffect": "core.status.hero.exp += 5e9",
	...
	"I738": {
		...
		"canUseItemEffect": "true",
		"text": "天地间充沛的能量滋养诞生的晶体，\n接触后能够化作海量的领悟为人所用。\n角色增加100万领悟。",
		"itemEffect": "core.status.hero.exp += 6e10",
		"itemEffectTip": "，经验+600亿"
	},
	"I739": {
		"cls": "items",
		"name": "神话的进化结晶",
		"canUseItemEffect": "true",
		"text": "天地间充沛的能量滋养诞生的晶体，\n接触后能够化作海量的领悟为人所用。\n角色增加1000万领悟。",
		"itemEffect": "core.status.hero.exp += 7e11",
		"itemEffectTip": "，经验+7000亿"
	},
	"I740": {
		"cls": "items",
		"name": "不朽的进化结晶",
		"canUseItemEffect": "true",
		"text": "天地间充沛的能量滋养诞生的晶体，\n接触后能够化作海量的领悟为人所用。\n角色增加1亿领悟。",
		"itemEffect": "core.status.hero.exp += 8e12",
		"itemEffectTip": "，经验+8兆"
	},
	"I743": {
		"cls": "constants",
	...
	"I772": {
		...
		"name": "轻质战盾（二阶）",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 400",
		"itemEffectTip": "，防御+400"
	},
	"I773": {
		"cls": "items",
		"name": "轻质战盾",
	...
	"I783": {
		...
		"name": "灵妖盾",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 5000000",
		"itemEffectTip": "，防御+500万"
	},
	"I784": {
		"cls": "items",
		"name": "冰寒果实",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 12000000",
		"itemEffectTip": "，防御+1200万"
	},
	"I785": {
		"cls": "items",
		"name": "灵巧结晶",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 4000e4",
		"itemEffectTip": "，防御+4000万"
	},
	"I786": {
		"cls": "items",
		"name": "荒兽盾",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 600000",
		"itemEffectTip": "，防御+60万"
	},
	"I787": {
		"cls": "items",
		"name": "鲜血盾",
	...
	"I895": {
		...
		"name": "三月断宵",
		"canUseItemEffect": "true",
		"text": "一位云霄级强者观想天地创出的剑法。角色全属性+30%。",
		"equip": {
			"type": 0,
			"value": {},
			"percentage": {
	...
	"I896": {
		...
		"name": "兽神残卷（一阶初成）",
		"canUseItemEffect": "true",
		"text": "天生兽神留下来的残卷，蕴含着无穷尽的伟力，带领血洛大陆的荒兽族群走向强盛与繁荣。角色全属性+30%，战斗伤害-40%。",
		"equip": {
			"type": 0,
			"value": {},
			"percentage": {
	...
	"I897": {
		...
		"name": "兽神残卷（一阶大成）",
		"canUseItemEffect": "true",
		"text": "天生兽神留下来的残卷，蕴含着无穷尽的伟力，带领血洛大陆的荒兽族群走向强盛与繁荣。角色全属性+65%，战斗伤害-40%。",
		"equip": {
			"type": 0,
			"value": {},
			"percentage": {
	...
	"I898": {
		...
		"text": "无心之水，赐予万物以生命，却不求有功，只求无过。角色全属性+65%。"
	},
	"I899": {
		"cls": "equips",
		"name": "兽神残卷（二阶初成）",
		"canUseItemEffect": "true",
		"text": "天生兽神留下来的残卷，蕴含着无穷尽的伟力，带领血洛大陆的荒兽族群走向强盛与繁荣。角色全属性+110%，战斗伤害-40%。",
		"equip": {
			"type": 0,
			"value": {},
			"percentage": {
	...
	"I900": {
		...
		"text": "释放身体蕴含的基因原力，融解星宙间那颗颗璀璨的星辰。角色全属性+110%。"
	},
	"I901": {
		"cls": "equips",
		"name": "映星花",
		...
		"text": "绚烂得让人目不暇接的招式，奇异的波动流转，映出彗星尾巴般的光晕，似要将整个星河染上瑰丽的色彩。角色全属性+150%。"
	},
	"I902": {
		"cls": "items",
		"name": "绿钥匙串（四把）",
	...
	"I920": {
		...
		"text": "天生兽神留下来的残卷，蕴含着无穷尽的伟力，带领血洛大陆的荒兽族群走向强盛与繁荣。角色全属性+150%，战斗伤害-40%。"
	},
	"I921": {
		"cls": "equips",
		"name": "兽神残卷（二阶圆满）",
		"canUseItemEffect": "true",
		"text": "天生兽神留下来的残卷，蕴含着无穷尽的伟力，带领血洛大陆的荒兽族群走向强盛与繁荣。角色全属性+220%，战斗伤害-40%。",
		"equip": {
			"type": 0,
			"value": {},
			"percentage": {
	...
	"I922": {
		...
		"text": "神秘令人难以捉摸的进阶术式，于内敛的紫色光华之中，蕴含着令人心惊胆颤的力量。角色全属性+220%。"
	},
	"I923": {
		"cls": "equips",
		"name": "映星天彩",
		...
		"text": "仿若启明星映照着深邃的深渊，划破了那一方神秘的黑暗。符号和魔法阵交织变幻，无穷尽的力量似乎正由沉睡中被唤醒。角色全属性+365%。"
	},
	"I924": {
		"cls": "equips",
		"name": "兽神残卷（三阶初成）",
		"canUseItemEffect": "true",
		"text": "天生兽神留下来的残卷，蕴含着无穷尽的伟力，带领血洛大陆的荒兽族群走向强盛与繁荣。角色全属性+365%，战斗伤害-40%。",
		"equip": {
			"type": 0,
			"value": {},
			"percentage": {
	...
	"I926": {
		...
		"name": "白尘贯天",
		"canUseItemEffect": "true",
		"text": "与天地之间尘埃的律动产生共鸣，精神念力沟通天地能量，借由其中奥秘，衍化为自身势不可挡的念力领域。角色全属性+520%。",
		"equip": {
			"type": 0,
			"value": {},
			"percentage": {
	...
	"I1114": {
		...
		"name": "荒兽角",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += 600e8",
		"itemEffectTip": "，攻击+600亿"
	},
	"I1115": {
		"cls": "items",
		"name": "荒兽筋",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 400e8",
		"itemEffectTip": "，防御+400亿"
	},
	"I1116": {
		"cls": "items",
		"name": "黑爪枝丫",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += 1500e8",
		"itemEffectTip": "，攻击+1500亿"
	},
	"I1117": {
		"cls": "items",
		"name": "白雾枝丫",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 3000e8",
		"itemEffectTip": "，防御+3000亿"
	},
	"I1118": {
		"cls": "items",
		"name": "万年赤铁石",
		...
		"itemEffectTip": "，攻击+1.5兆"
	},
	"I1119": {
		"cls": "items",
		"name": "万年冰山玉",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += 1.5e12",
		"itemEffectTip": "，防御+1.5兆"
	},
	"I1120": {
		"cls": "items",
		"name": "珍海圣珠",
	...
	"I1124": {
		...
		"name": "银霜月轮（一重）",
		"canUseItemEffect": "true",
		"text": "由216颗白水晶组合而成的念力兵器，晶莹的色泽仿佛天使之翼流落于世间，亮丽的外表下是无坚不摧的威势。攻击+1314万，同时+36%。",
		"equip": {
			"type": 1,
			"value": {
				"atk": 13140000
	...
	"I1125": {
		...
		"name": "银霜月轮（二重）",
		"canUseItemEffect": "true",
		"text": "由216颗白水晶组合而成的念力兵器，晶莹的色泽仿佛天使之翼流落于世间，亮丽的外表下是无坚不摧的威势。攻击+13.14亿，同时+80%。",
		"equip": {
			"type": 1,
			"value": {
				"atk": 1314000000
	...
	"I1126": {
		...
		"name": "银霜月轮（三重）",
		"canUseItemEffect": "true",
		"text": "由216颗白水晶组合而成的念力兵器，晶莹的色泽仿佛天使之翼流落于世间，亮丽的外表下是无坚不摧的威势。攻击+640亿，同时+140%。",
		"equip": {
			"type": 1,
			"value": {
				"atk": 64000000000
	...
	"I1127": {
		...
		"name": "银霜月轮（四重）",
		"canUseItemEffect": "true",
		"text": "由216颗白水晶组合而成的念力兵器，晶莹的色泽仿佛天使之翼流落于世间，亮丽的外表下是无坚不摧的威势。攻击+3000亿，同时+225%。",
		"equip": {
			"type": 1,
			"value": {
				"atk": 300000000000
	...
	"I1148": {
		...
		"name": "残破神石·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 5000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*5000)}"
	},
	"I1149": {
		"cls": "items",
		"name": "残破神石·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 5000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 5000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 5000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 576000;"
	},
	"I1150": {
		"cls": "items",
		"name": "极位神石·红",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 50000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*50000)}"
	},
	"I1151": {
		"cls": "items",
		"name": "极位神石·蓝",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 50000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*50000)}"
	},
	"I1152": {
		"cls": "items",
		"name": "极位神石·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 50000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 50000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 50000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 20736000;"
	},
	"I1153": {
		"cls": "items",
		"name": "极位神石·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 50000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*50000)}"
	},
	"I1154": {
		"cls": "items",
		"name": "神灵天水",
	...
	"I1162": {
		...
		"name": "混沌神石·红",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 100000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*100000)}"
	},
	"I1163": {
		"cls": "items",
		"name": "混沌神石·蓝",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 100000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*100000)}"
	},
	"I1164": {
		"cls": "items",
		"name": "混沌神石·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 100000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 100000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 100000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 82944000;"
	},
	"I1165": {
		"cls": "items",
		"name": "混沌神石·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 100000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*100000)}"
	},
	"I1166": {
		"cls": "items",
		"name": "神乞·红",
	...
	"I1178": {
		...
		"name": "陨墨九诀（小成）",
		"canUseItemEffect": "true",
		"text": "陨墨星一脉精神念力修炼方法。凝、韧、散、锐、柔、刚、舞、幻、融，九诀小成后，精神念力凝练至无比坚韧，无懈可击。攻击、防御+2000亿，护盾*10。",
		"equip": {
			"type": 5,
			"value": {
				"def": 200000000000,
	...
	"I1181": {
		...
		"name": "绮晶",
		"canUseItemEffect": "true",
		"text": "诞生于天地秘境之中的神异D级金属，蕴含一丝空间元素，通过扭曲空间以吸收来袭的力量，足以化解域主之下绝大多数的攻势。防御+4096万，同时+20%；魔防+8亿，同时+40%。",
		"equip": {
			"type": 2,
			"value": {
				"mdef": 800000000,
	...
	"I1419": {
		...
		"name": "永恒神石·红",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 200000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*200000)}"
	},
	"I1420": {
		"cls": "items",
		"name": "永恒神石·蓝",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 200000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*200000)}"
	},
	"I1421": {
		"cls": "items",
		"name": "永恒神石·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 200000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 200000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 200000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 331776000;"
	},
	"I1422": {
		"cls": "items",
		"name": "永恒神石·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 200000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*200000)}"
	},
	"I1423": {
		"cls": "items",
		"name": "奇迹红宝石",
	...
	"I1697": {
		...
		"name": "银霜月轮（圆满）",
		"canUseItemEffect": "true",
		"text": "由216颗白水晶组合而成的念力兵器，晶莹的色泽仿佛天使之翼流落于世间，亮丽的外表下是无坚不摧的威势。攻击+8兆，同时+440%。",
		"equip": {
			"type": 1,
			"value": {
				"atk": 8000000000000
	...
	"I1698": {
		...
		"name": "银霜月轮（五重）",
		"canUseItemEffect": "true",
		"text": "由216颗白水晶组合而成的念力兵器，晶莹的色泽仿佛天使之翼流落于世间，亮丽的外表下是无坚不摧的威势。攻击+2兆，同时+320%。",
		"equip": {
			"type": 1,
			"value": {
				"atk": 2000000000000
	...
	"I1700": {
		...
		"text": "天生兽神留下来的残卷，蕴含着无穷尽的伟力，带领血洛大陆的荒兽族群走向强盛与繁荣。角色全属性+520%，战斗伤害-40%。"
	},
	"I1701": {
		"cls": "equips",
		"name": "兽神残卷（三阶大成）",
	...
	"I1743": {
		...
		"name": "原始神石·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 10000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*10000)}"
	},
	"I1744": {
		"cls": "items",
		"name": "原始神石·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 10000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 10000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 10000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 1728000;"
	},
	"I1745": {
		"cls": "items",
		"name": "上位神石·红",
	...
	"I1747": {
		...
		"name": "上位神石·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 20000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*20000)}"
	},
	"I1748": {
		"cls": "items",
		"name": "上位神石·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 20000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 20000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 20000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 5184000;"
	},
	"I1749": {
		"cls": "items",
		"name": "冒险者的补给",
	...
	"I1756": {
		...
		"name": "古神的颂歌·红",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.hp += core.values.greenPotion * 4398046511104 * core.status.thisMap.ratio",
		"itemEffectTip": "，生命+${core.formatBigNumber(core.values.greenPotion * core.status.thisMap.ratio * 4398046511104)}"
	},
	"I1757": {
		"cls": "items",
		"name": "古神的颂歌·蓝",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.hp += core.values.greenPotion * 17592186044416 * core.status.thisMap.ratio",
		"itemEffectTip": "，生命+${core.formatBigNumber(core.values.greenPotion * core.status.thisMap.ratio * 17592186044416)}"
	},
	"I1758": {
		"cls": "items",
		"name": "古神的颂歌·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.hp += core.values.greenPotion * 70368744177664 * core.status.thisMap.ratio",
		"itemEffectTip": "，生命+${core.formatBigNumber(core.values.greenPotion * core.status.thisMap.ratio * 70368744177664)}"
	},
	"I1759": {
		"cls": "items",
		"name": "古神的颂歌·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.hp += core.values.greenPotion * 281474976710656 * core.status.thisMap.ratio",
		"itemEffectTip": "，生命+${core.formatBigNumber(core.values.greenPotion * core.status.thisMap.ratio * 281474976710656)}"
	},
	"I1760": {
		"cls": "items",
		"name": "『冗律』铁剑",
	...
	"I1782": {
		...
		"name": "芊缈叶·域初",
		"canUseItemEffect": "true",
		"text": "享有盛誉而又非常稀有的植物生命，以“生态恢复”的能力而著称，能够汲取环境中的负面能量与有害物质，转化为滋养自身的生命精华，并释放出净化光环，为宿主生命提供庇护。当前培养阶段为领域级初期，进化标志在于其叶片脉络与纹理的复杂度。（防具）防御+120%，护盾+240%。",
		"equip": {
			"type": 2,
			"value": {},
			"percentage": {
	...
	"I1797": {
		...
		"name": "陨墨九诀（大成）",
		"canUseItemEffect": "true",
		"text": "陨墨星一脉精神念力修炼方法。凝、韧、散、锐、柔、刚、舞、幻、融，九诀大成，精神念力变化无穷，各种复杂的攻坚手段信手拈来，甚至能够洞察到同阶对手的情绪与意图，从而在战斗中占据先机。攻击、防御+7000亿，护盾*25。",
		"equip": {
			"type": 5,
			"value": {
				"def": 700000000000,
	...
	"I2081": {
		...
		"name": "古神·遗泽[红]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 2000000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*2000000)}"
	},
	"I2082": {
		"cls": "items",
		"name": "古神·遗泽[蓝]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 2000000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*2000000)}"
	},
	"I2083": {
		"cls": "items",
		"name": "古神·遗泽[绿]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 2000000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*2000000)}"
	},
	"I2084": {
		"cls": "items",
		"name": "古神·遗泽[黄]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 2000000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 2000000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 2000000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 42467328000;"
	},
	"I2085": {
		"cls": "items",
		"name": "古神·轮回[红]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 10000000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*10000000)}"
	},
	"I2086": {
		"cls": "items",
		"name": "古神·轮回[蓝]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 10000000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*10000000)}"
	},
	"I2087": {
		"cls": "items",
		"name": "古神·轮回[绿]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 10000000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*10000000)}"
	},
	"I2088": {
		"cls": "items",
		"name": "古神·轮回[黄]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 10000000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 10000000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 10000000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 849346560000;"
	},
	"I2089": {
		"cls": "items",
		"name": "生命？",
	...
	"I2092": {
		...
		"name": "创世神石·红",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 500000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*500000)}"
	},
	"I2093": {
		"cls": "items",
		"name": "创世神石·蓝",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 500000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*500000)}"
	},
	"I2094": {
		"cls": "items",
		"name": "创世神石·黄",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 500000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 500000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 500000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 1327104000;"
	},
	"I2095": {
		"cls": "items",
		"name": "创世神石·绿",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 500000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*500000)}"
	},
	"I2096": {
		"cls": "items",
		"name": "古神·窥见[红]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 1000000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*1000000)}"
	},
	"I2097": {
		"cls": "items",
		"name": "古神·窥见[蓝]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 1000000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*1000000)}"
	},
	"I2098": {
		"cls": "items",
		"name": "古神·窥见[黄]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 1000000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 1000000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 1000000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 5308416000;"
	},
	"I2099": {
		"cls": "items",
		"name": "古神·窥见[绿]",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 1000000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*1000000)}"
	},
	"I2100": {
		"cls": "items",
		"name": "浑源的息动「红」",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 50000000",
		"itemEffectTip": "，攻击+${core.formatBigNumber(core.values.redGem * core.status.thisMap.ratio*50000000)}"
	},
	"I2101": {
		"cls": "items",
		"name": "浑源的息动「蓝」",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 50000000",
		"itemEffectTip": "，防御+${core.formatBigNumber(core.values.blueGem * core.status.thisMap.ratio*50000000)}"
	},
	"I2102": {
		"cls": "items",
		"name": "浑源的息动「绿」",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 50000000",
		"itemEffectTip": "，护盾+${core.formatBigNumber(core.values.greenGem * core.status.thisMap.ratio*50000000)}"
	},
	"I2103": {
		"cls": "items",
		"name": "浑源的息动「黄」",
		"canUseItemEffect": "true",
		"itemEffect": "core.status.hero.atk += core.values.redGem * core.status.thisMap.ratio * 50000000;\ncore.status.hero.def += core.values.blueGem * core.status.thisMap.ratio * 50000000;\ncore.status.hero.mdef += core.values.greenGem * core.status.thisMap.ratio * 50000000;\ncore.status.hero.hp += core.values.yellowPotion * core.status.thisMap.ratio * 16986931200000;"
	},
	"I2104": {
		"cls": "items",
		"name": "新物品",
